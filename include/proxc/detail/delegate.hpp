//          Copyright Sergey Ryazanov 2005.
...
namespace std
{
  ...
  struct hash<proxc::detail::delegate<R (A...)> >
  {
    size_t operator()(proxc::detail::delegate<R (A...)> const& d) const noexcept
    {
      auto const seed(hash<void*>()(d.object_ptr_));

      return hash<typename proxc::detail::delegate<R (A...)>::stub_ptr_type>()(
